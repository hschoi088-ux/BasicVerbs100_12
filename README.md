...
<body oncontextmenu="return false">
    ...
    <div class="max-w-md mx-auto px-4 py-6">
        ...
        <div class="flex space-x-2 mb-6 overflow-x-auto pb-2 no-scrollbar font-bold text-sm">
            ...
            <button onclick="selectWeek('9-12')" id="tab-9-12" class="week-tab flex-shrink-0 px-5 py-2 bg-white rounded-full shadow-sm border border-slate-100">Week 9-12 누적</button>
        </div>
    ...
    <script>
        ...
        function selectWeek(w) {
            ...
            if (w === '9-12') {
                titleEl.innerText = 'WEEK 9-12 누적';
            } else {
        ...
        function startQuiz(mode) {
            ...
            let weekData = [];
            if (selectedWeek === '9-12') {
                // 누적 탭일 경우 9, 10, 11, 12주차 모두 합산
                weekData = allData.filter(item => item.w >= 9 && item.w <= 12);
            } else {
                // 개별 주차
